...
Abre `Taqueria_RyR_Landing.html` directamente en el navegador. Es un archivo autocontenido (HTML + CSS + JS embebido), sin build ni dependencias — solo requiere conexión a internet para cargar las tipografías de Google Fonts (Baloo 2 y Nunito).
...
- `Taqueria_RyR_Landing.html` — el entregable: la landing/menú completa.
